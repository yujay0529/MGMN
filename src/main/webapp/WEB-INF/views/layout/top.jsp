					...
					<div class="container">
						...
						<div class="navbar-header">
							...
							<a class="navbar-brand" href="/"
								style="width: 300px; height: 20px; font-size: 30px;">MGMN</a>
						</div>
						...
						<div class="collapse navbar-collapse"
							...
							<ul class="nav navbar-nav navbar-right">
								...
								<c:if test="${empty sessionScope.sid }">
									<li><a href="<c:url value='/joinForm'/>">Join</a>
									<li>
									<li><a href="<c:url value='/loginForm'/>">Login</a>
									<li>
								...
								<c:if test="${not empty sessionScope.sid}">
									...
									<li><a href="<c:url value='noticeList' />">Notice</a></li>
									<li><a href="<c:url value='/BoardList'/>">이벤트</a>
									<li>
