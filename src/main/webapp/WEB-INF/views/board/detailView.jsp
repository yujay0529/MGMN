...
<body>
   ...
   <form id="detailForm" method="post" action="<c:url value='/BoardList'/>">
      <h3 id="title"></h3>
      <table>
         <tr><th id="title_r" colspan="4">${board.brdTitle }</th></tr>
         
         <tr><th>작성자</th><th>${board.userId }</th><th>작성일</th><th>${board.brdDate }</th><tr>
            <tr><td colspan="4">${board.brdCon }</td></tr>
            <tr id="gray"><th colspan="4"><input type="submit" value="뒤로가기"> <%-- <button><a href="./updateForm/${board.brdNo}">수정하기</a></button> --%>
